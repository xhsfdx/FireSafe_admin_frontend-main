<template>
  <div class="basic-info-page">
    ...
    <!-- 表单内容 -->
    <div v-loading="loading" class="form-container" element-loading-text="加载中...">
  ...
  methods: {
    ...
    async savePointInfoToServer(formData) {
      try {
        ...
        // 调用后端API更新点位信息
        // 使用正确的API路径更新点位信息
        const response = await request.put(`/point/maintainPoint/checkpoint/${pointId}`, requestData)
