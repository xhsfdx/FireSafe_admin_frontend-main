<template>
  <div class="fault-order-detail-page">
    ...
    <div class="progress-section">
      <el-card class="progress-card" shadow="never">
        ...
        <el-steps :active="getProgressStep()" finish-status="success" align-center>
          ...
          <el-step title="已接单" description="已有人接单" />
          <el-step title="已分配" description="已分配人员" />
          <el-step title="已沟通" description="已与客户沟通" />
          <el-step title="已签到" description="已到达现场" />
          <el-step title="处理中" description="正在处理故障" />
          <el-step title="已解决" description="故障已解决" />
          <el-step title="已评价" description="客户已评价" />
        </el-steps>
      </el-card>
    </div>

    <!-- 处理人员信息 -->
    <div v-if="orderInfo" class="staff-section">
    ...
    <!-- 沟通记录 -->
    <div v-if="orderInfo && orderInfo.communicationLogs && orderInfo.communicationLogs.length > 0" class="communication-section">
    ...
    <!-- 签到记录 -->
    <div v-if="orderInfo && orderInfo.signInLogs && orderInfo.signInLogs.length > 0" class="signin-section">
    ...
    <!-- 故障照片 -->
    <div v-if="orderInfo && orderInfo.faultPhotos && orderInfo.faultPhotos.length > 0" class="photos-section">
      <el-card class="photos-card" shadow="never">
        ...
        <div class="photos-grid">
          ...
          >
            ...
            <div v-if="photo.description" class="photo-description">{{ photo.description }}</div>
          </div>
        </div>
      </el-card>
    </div>
    ...
    <!-- 评价信息 -->
    <div v-if="orderInfo && (orderInfo.rating || orderInfo.comment)" class="rating-section">
      <el-card class="rating-card" shadow="never">
        ...
        <div class="rating-content">
          <div v-if="orderInfo.rating" class="rating-score">
            <label>评分:</label>
            <el-rate
          ...
          <div v-if="orderInfo.comment" class="rating-comment">
            <label>评价内容:</label>
            <div class="comment-text">{{ orderInfo.comment }}</div>
          </div>
          <div v-if="orderInfo.ratedAt" class="rating-time">
            <label>评价时间:</label>
